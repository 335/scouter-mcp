// Ported from scouter.webapp v2.20.0 (Apache License 2.0) — source: scouterx.webapp.framework.client.server.Server
/*
...
public class Server {
	...
	public Server(String ip, String port, String name) {
		...
		this.name = name;
		this.connPool = new ConnectionPool(ClientConfig.NET_WEBAPP_TCP_CLIENT_POOL_SIZE);
